...
GEMINI_TEXT_MODEL = os.environ.get("GEMINI_TEXT_MODEL", "models/gemini-3.1-flash-lite")
GEMINI_VISION_MODEL = os.environ.get("GEMINI_VISION_MODEL", "models/gemini-3.1-flash-lite")
